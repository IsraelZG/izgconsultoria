...
import { Monitor, Cog, LayoutDashboard, ArrowRight, type LucideIcon } from "lucide-react";
...
const solutions: Solution[] = [
  ...
  },
  {
    ...
    tags: ["Cálculos Automatizados", "Consolidação", "Integração"],
  },
  {
    ...
    tags: ["Sob Medida", "Dashboard", "Relatórios"],
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-[#94A3B8]">
            Da digitalização de planilhas à automação completa de rotinas, entregamos tecnologia que fala a língua do seu departamento financeiro.
          </p>
        </motion.div>
